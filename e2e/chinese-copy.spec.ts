...
test("Chinese copy uses corrected names and natural labels across seven screens", async ({ page }) => {
  ...
  const checks = [
    ["home", ["数字健康", "边缘智能", "智能体", "企业应用价值", "E-Linus 智慧养老照护", "PDM Robot 资产剩余寿命监测", "怡合智能与", "王泓清博士（Jeff Wang）", "周俊杰博士（Chaw Jun Kit）"]],
    ...
    ["partners", ["Mobiva"]],
    ["team", ["王泓清博士（Jeff Wang）", "学术署名：Wang Hongqing", "周俊杰博士（Chaw Jun Kit）", "数字健康 / 边缘智能 / 智能体", "hongqing.wang812@gmail.com", "Wendy Leong Pooi Yan"]],
