...
const content = {
  ...
  "zh-CN": {
    ...
    "intro": "怡合智能将先进机器学习转化为医疗健康、智慧城市和工业领域的企业级应用。",
    "explore": "探索研究支柱",
    "sections": ["概览", "数字健康", "边缘智能", "智能体", "协同关系", "应用场景"],
    ...
    "pillars": [
      ...
      },
      {
        ...
        "questions": "1. 通过检索增强生成（RAG）技术实现市政与智慧旅游服务自动化。2. 利用具备情绪智能的对话式数字人增强数字交互。3. 基于基础模型的大规模专利挖掘与文本分析。",
    ...
    "mapping": [
      ...
      "基于检索增强生成（RAG）的数字礼宾；国家地址系统；诈骗监测；钉钉办公助手；TikTok 获客与销售。"
    ],
