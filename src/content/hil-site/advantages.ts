...
export const advantagesContent = {
  en: {
    intro: "Eight technology advantages connect robust models with deployment constraints. A-01 to A-03 are the proven core; A-04 to A-08 remain frontier capabilities.",
    core: ["Core advantages", "Three technologies, one deployment discipline", "A-01 to A-03 form the proven core: prediction, orchestration and on-device perception."],
    ...
    evidence: ["Field evidence", "Methods are tested where constraints are visible", "The image rhythm follows HOME’s Inside the Lab section and can later accept real lab photography without changing the layout."],
    photos: [
    ...
    frontier: ["Frontier reserve", "Five capabilities kept in view", "A-04 to A-08 remain concise, traceable and ready for deeper technical documentation."],
    capabilities: [
  ...
  "zh-CN": {
    intro: "八项技术优势将稳健模型与部署约束连接起来。A-01 至 A-03 是经过验证的核心技术；A-04 至 A-08 为前沿技术储备。",
    core: ["核心优势", "三项技术，一套部署准则", "A-01 至 A-03 构成核心：预测、编排与端侧感知。"],
    ...
    values: [
      "在噪声较多和资源受限条件下保持准确预测，并有 SAS 认证与 B2B 应用实践支持。",
      "为民生数字礼宾和个性化健康指导提供情境感知交互。",
      "不依赖云端实现毫秒级感知，降低 AIoT 硬件的延迟与隐私暴露。",
    ],
    evidence: ["现场验证", "在约束清晰可见的现场验证方法", "图片节奏沿用首页的“走进实验室”版块，后续可替换为真实实验室摄影，而无需改变布局。"],
    photos: [
      ["模型评审", "联合检查失败案例与分割输出。", "研究人员检查视觉模型结果"],
      ["硬件验证", "将延迟、感知和嵌入式计算作为一个系统进行测量。", "嵌入式摄像头硬件验证"],
      ["原型集成", "模型从基准测试结果走向设备行为。", "研究人员集成边缘人工智能原型"],
    ],
    frontier: ["前沿储备", "持续关注的五项能力", "A-04 至 A-08 保持简洁、可追溯，为更深入的技术文档做好准备。"],
    capabilities: [
      ["跨模型 Skill 编译与运行治理", "跨模型与运行环境编译 Skill，结合依赖绑定、并发编排、反馈优化和回滚，使成功率、延迟与失败原因更容易追踪。"],
      ["用户可控的分层 AI 记忆", "分离工作记忆、长期记录与建议层，使来源、权限、到期与删除保持可控。"],
      ["效用—多样性训练数据选择", "选择高效用且不重复的样本，在固定算力预算内增加有效更新。"],
      ["设备端 Agent 与硬件协同", "在受限硬件上，通过事件驱动的智能体循环连接传感器、本地记忆与执行器。"],
