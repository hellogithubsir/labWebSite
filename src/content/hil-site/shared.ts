...
export const sharedContent = {
  en: {
    ...
    titles: { home: "Bridging Human Perception and Machine Intelligence at the Edge.", research: "Core Research Pillars", projects: "Projects", advantages: "Technology Advantages", partners: "Partners", team: "Team", contact: "Contact" },
  ...
  "zh-CN": {
    ...
    titles: { home: "在边缘端连接人类感知与机器智能。", research: "核心研究支柱", projects: "项目展示", advantages: "技术优势", partners: "合作伙伴", team: "团队", contact: "联系合作" },
