...
export const sharedContent = {
  en: {
    ...
    titles: { home: "Bridging Human Perception and Machine Intelligence at the Edge.", research: "Core Research Pillars", projects: "Applied Research Projects", advantages: "Technology Advantages", partners: "Partners", team: "Team", contact: "Contact" },
    skip: "Skip to content", navigation: "Primary navigation", menu: "Menu", closeMenu: "Close menu",
    logoAlt: "Harmonizing Intelligence Lab", exploreResearch: "Explore Research", collaborate: "Collaborate",
  },
  "zh-CN": {
    ...
    logoAlt: "怡合智能", exploreResearch: "探索研究方向", collaborate: "联系合作",
  },
