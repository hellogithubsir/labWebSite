...
实现 C-01 至 C-06，包括合作对象、合作形式、学生申请、联系信息和沟通说明。提供 Figma 指定的邮件与外部链接动作；V1 不增加提交表单或后端发送能力。

### Acceptance criteria

- [ ] 两种语言下 C-01 至 C-06 的可见内容完整，合作与申请要求不互相混淆。
- [ ] 邮件和 Figma 指定外链使用正确目标，可由键盘激活，并提供清晰可见的焦点状态。
...
- 外部链接只使用 Figma 或参考文档明确提供的目标，不猜测社交账号。
