...
在 023 的唯一 Projects 画面中加入设计交付要求的全部项目卡片和详情状态，内容使用 P-03、P-05、P-06、P-07、P-08 对应条目。仅使用 Ticket 001 登记的项目媒体；合作 CTA 切换到 Contact。

### Acceptance criteria

- [ ] 两种语言下可浏览设计交付要求的全部项目，标题、类别、摘要、详情和媒体与内容编号一致。
- [ ] 卡片、Accordion 或其他设计交付指定详情状态可由键盘和指针操作，且任意时刻只暴露正确详情。
